...
대화 내용을 정밀 분석하여 다음 3가지 카테고리 중 하나로 call_type을 필수 판별하고, 아래 작성 규칙에 따라 오직 순수 JSON 형식으로만 응답하세요.
...
[분석 항목]
- call_type: "REPAIR", "INQUIRY", "IRRELEVANT" 중 하나
...
[출력 형식 예시]
{
  ...
  "summary": "바닥 흡입력 약화 건으로 동영상 촬영 및 서비스 안내 예정."
}"""
